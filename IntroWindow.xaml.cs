...
В соответствии с условиями настоящего Соглашения ПРАВООБЛАДАТЕЛЬ предоставляет ПОЛЬЗОВАТЕЛЮ право на установку и использование одного экземпляра ПРОГРАММНОГО ПРОДУКТА, а также право на изготовление резервных копий, используемой в случае утраты или порчи основных носителей из состава ПРОГРАММНОГО ПРОДУКТА.
ПОЛЬЗОВАТЕЛЬ не вправе изменять, декомпилировать, дешифровать и производить иные действия с объектным кодом ПРОГРАММНОГО ПРОДУКТА, имеющие целью получение информации о реализации алгоритмов, используемых в ПРОГРАММНОМ ПРОДУКТЕ, а также создавать производные произведения с использованием ПРОГРАММНОГО ПРОДУКТА.
...
Простая (неисключительная) лицензия на ПРОГРАММНЫЙ ПРОДУКТ предоставляется на условиях «как есть»: ПРАВООБЛАДАТЕЛЬ не предоставляет никаких гарантий соответствия ПРОГРАММНОГО ПРОДУКТА конкретным целям и ожиданиям ПОЛЬЗОВАТЕЛЯ, а также не предоставляет никаких иных гарантий, прямо не указанных в настоящем Соглашении. ПОЛЬЗОВАТЕЛЬ
принимает на себя ответственность за выбор ПРОГРАММНОГО ПРОДУКТА с целью достижения желаемых результатов и в отношении результатов, получаемых в ходе использования ПОЛЬЗОВАТЕЛЕМ ПРОГРАММНОГО ПРОДУКТА.
